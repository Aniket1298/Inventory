...
class ProductHistory extends StatefulWidget {
  ...
  const ProductHistory({Key key,this.index ,this.url,this.product,this.date,this.rate,this.units,this.amount,this.customer,this.dues,this.paid,this.transactionid}) : super(key: key);
  @override
              ...
              children: <Widget>[
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Text('Rate ₹ '+widget.rate.toString(),
                          style: TextStyle(
                              fontFamily: 'Avenir Next',
                              fontSize: screenheight(context)*0.013,
                              color: const Color(0xffd28e62),
                      ...
                      Text('Units'+widget.units.toString(),
                        style: TextStyle(
                              fontFamily: 'Avenir Next',
                              fontSize: screenheight(context)*0.013,
                              color: Colors.black,
                              ...
                              return Container(
                                child: Row(
                                  children: <Widget>[
                                    ...
                                    Text(widget.dues.toString()+' Dues',
                                        style: TextStyle(
                                          fontSize: screenheight(context)*0.013,
                ...
                Container(
                  child: Column(
                    ...
                    children: <Widget>[
                      util(label: 'Customer :',),
                      util(label: 'Total Amount :',),
                      util(label: 'Date :',),
                      util(label:'Transaction ID : ' ,),
                ...
                Container(
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      util2(label: widget.amount.toString(),),
                      util2(label: widget.date,),
                      util2(label: widget.transactionid.toString(),),
                    ],
                  ),
                ),
              ],
