    ...
    return MaterialApp(
      home: Scaffold(
        ...
        body: CustomPaint(
          ...
          child: ListView(
            children: <Widget>[
              Header(title: 'MY PRODUCTS STOCK',),
              PurchaseHistory(),
    ...
    return Container(
      ...
      child: Column(
        children: <Widget>[
          ...
          UtilRow(item:'Chocolate',quantity: 15,rate: 10,date:'2012-12-12',),
          UtilRow(item:'Chocolate',quantity: 15,rate: 10,date:'2012-12-12',),
          UtilRow(item:'Chocolate',quantity: 15,rate: 10,date:'2012-12-12',),
          UtilRow(item:'Chocolate',quantity: 15,rate: 10,date:'2012-12-12',),
          UtilRow(item:'Chocolate',quantity: 15,rate: 10,date:'2012-12-12',),
...
class UtilRow extends StatelessWidget {
  ...
  const UtilRow({Key key, this.item, this.quantity, this.rate, this.date}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return Container(
