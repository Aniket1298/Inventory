        ...
        body: CustomPaint(
          ...
          child: ListView(
            children: <Widget>[
              ...
              Container(
                padding: EdgeInsets.fromLTRB(screenwidth(context) * 0.03, 0,
                    screenwidth(context) * 0.03, 0),
                child: Row(
                  children: <Widget>[
                    Text(
                      'Sort By:',
              ...
              children: <Widget>[
                FlatButton(
                  ...
                  onPressed: () {
                    Navigator.push(context,
                        MaterialPageRoute(builder: (context) => FullPayment()));
                    /*...*/
                  },
                  child: Text(
                    "Full Paid Payments",
                ...
                FlatButton(
                  ...
                  onPressed: () {
                    /*...*/
                    Navigator.push(context,
                        MaterialPageRoute(builder: (context) => DuesPayment()));
                  },
                  child: Text(
                    "With Dues Payments",
                    style: TextStyle(fontSize: 12.0),
              ...
              child: Column(
                children: <Widget>[
                  Container(
                    ...
                    child:
                        Image.asset('assets/icons/rupee.png', fit: BoxFit.fill),
                  ),
                  Container(
