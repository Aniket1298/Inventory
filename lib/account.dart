  ...
  Widget build(BuildContext context) {
    return Container(
        padding: EdgeInsets.fromLTRB(
            screenwidth(context) * 0.04, 0, screenwidth(context) * 0.04, 0),
        child: Column(
          children: <Widget>[
            SafeArea(
              child: Row(
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      margin: EdgeInsets.fromLTRB(
          screenwidth(context) * 0.04, 0, screenwidth(context) * 0.05, 0),
      child: Column(
        children: <Widget>[
          Container(
            child: Row(
              ...
              children: [
                Container(
                  padding: EdgeInsets.fromLTRB(screenwidth(context) * 0.04, 0,
                      screenwidth(context) * 0.04, 0),
          ...
          Container(
              padding: EdgeInsets.fromLTRB(screenwidth(context) * 0.05, 0,
                  screenwidth(context) * 0.05, 0),
              child: Column(
                children: <Widget>[
                  Center(
                    child: Row(
